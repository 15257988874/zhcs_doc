...
function() {
	...
	s.object.extend(o.prototype, {
		...
		_createSearchTemplate: function() {
			if (!this._div) {
				...
				'<div class="BMapLib_bubble_close" title="鍏抽棴" id="BMapLib_bubble_close' + this.guid + '">', 
				"</div>", 
				'<div class="BMapLib_sendToPhone" title="鍙戦€佸埌鎵嬫満" id="BMapLib_sendToPhone' + this.guid + '">', 
				"</div>",
				"</div>", 
				"</div>", 
				...
				'<span class="BMapLib_icon BMapLib_icon_nbs"></span>鍦ㄩ檮杩戞壘', 
				"</li>", '<li class="" id="BMapLib_tab_tohere' + this.guid + '" style="display:block;">', 
				'<span class="BMapLib_icon BMapLib_icon_tohere"></span>鍒拌繖閲屽幓', "</li>", 
				'<li class="" id="BMapLib_tab_fromhere' + this.guid + '" style="display:block;">', 
				'<span class="BMapLib_icon BMapLib_icon_fromhere"></span>浠庤繖閲屽嚭鍙�', 
				"</li>", 
				"</ul>",
				'<ul class="BMapLib_nav_tab_content">',
				'<li id="BMapLib_searchBox' + this.guid + '">',
				'<table width="100%" align="center" border=0 cellpadding=0 cellspacing=0>', 
				'<tr><td style="padding-left:8px;"><input id="BMapLib_search_text' + this.guid + '" class="BMapLib_search_text" type="text" maxlength="100" autocomplete="off"></td><td width="55" style="padding-left:7px;"><input id="BMapLib_search_nb_btn' + this.guid + '" type="submit" value="鎼滅储" class="iw_bt"></td></tr>',
				"</table>", 
				"</li>", 
				'<li id="BMapLib_transBox' + this.guid + '" style="display:none">',
				'<table width="100%" align="center" border=0 cellpadding=0 cellspacing=0>', 
				'<tr><td width="30" style="padding-left:8px;"><div id="BMapLib_stationText' + this.guid + '">璧风偣</div></td><td><input id="BMapLib_trans_text' + this.guid + '" class="BMapLib_trans_text" type="text" maxlength="100" autocomplete="off"></td><td width="106" style="padding-left:7px;"><input id="BMapLib_search_bus_btn' + this.guid + '" type="button" value="鍏氦" class="iw_bt" style="margin-right:5px;"><input id="BMapLib_search_drive_btn' + this.guid + '" type="button" class="iw_bt" value="椹捐溅"></td></tr>',
				"</table>", 
				"</li>",
				"</ul>", 
				"</div>", 
				...
				'<img src="../../../res/img/monitor/wt-bottom.png" width="58" height="31" alt="" class="BMapLib_trans" id="BMapLib_trans' + this.guid + '" style="left:144px;"/>'];
				t.innerHTML = e.join(""),
				this._div = t
			}
			return this._div
		...
		_showTabContent: function(t) {
			...
			case BMAPLIB_TAB_TO_HERE:
				...
				this.dom.stationText.innerHTML = "璧风偣",
			...
			case BMAPLIB_TAB_FROM_HERE:
				...
				this.dom.searchBox.style.display = "none",
				this.dom.transBox.style.display = "block",
				this.dom.stationText.innerHTML = "缁堢偣",
		...
		_transitRouteComplete: function(t, e) {
			...
			if (i == BMAP_STATUS_UNKNOWN_ROUTE) {
				...
				o = "";
				o = "鎵句笉鍒扮浉鍏崇殑绾胯矾",
				n == BMAP_ROUTE_STATUS_EMPTY && s == BMAP_ROUTE_STATUS_EMPTY ? o = "鎵句笉鍒扮浉鍏崇殑璧风偣鍜岀粓鐐�": (n == BMAP_ROUTE_STATUS_EMPTY && (o = "鎵句笉鍒扮浉鍏崇殑璧风偣"), s == BMAP_ROUTE_STATUS_EMPTY && (o = "鎵句笉鍒扮浉鍏崇殑缁堢偣")),
		...
		_searchAddress: function(t) {
			...
			i && (this.dom.panel.address.style.display = "block", this.dom.panel.address.innerHTML = "璇烽€夋嫨鍑嗙‘鐨�" + o),
	...
	t.prototype.initialize = function(t) {
		...
		i.innerHTML = '<input type="text" value="' + n._radius + '" style="width:30px;" id="BMapLib_search_radius' + this.guid + '"/>m <a href="javascript:void(0)" title="淇敼" onclick="BMapLib.SearchInfoWindow.instance[' + this.guid + ']._changeSearchRadius()" style="font-size:12px;text-decoration:none;color:blue;">淇敼</a>',
	...
	s.extend(e.prototype, {
		...
		generalDom: function() {
			...
			t.style.cssText = "position:absolute;background:#fff;width:480px;height:260px;top:" + i + "px;left:" + n + "px;ovflow:hidden;";
			var s = ['<div class="BMapLib_sms_tab_container">', "<span>鍙戦€佸埌鎵嬫満</span>", '<span id="BMapLib_sms_tip" style="display:none;">', "</span>", "</div>", '<div id="BMapLib_sms_pnl_phone" class="BMapLib_sms_pnl_phone" style="display: block;">', '<div class="BMapLib_ap" id="pnl_phone_left" style="display: block;">', "<table>", "<tr>", "<th>鍙戦€佹柟鎵嬫満鍙�</th>", '<td><input type="text" bid="" id="BMapLib_phone_0" maxlength="11" class="BMapLib_sms_input BMapLib_sms_input_l" /><span id="BMapLib_activateTip"></span></td>', "</tr>", '<tr id="BMapLib_activateBox" style="display:none;">', "<th>婵€娲荤爜</th>", '<td><input type="text" id="BMapLib_activate" class="BMapLib_sms_input BMapLib_sms_input_s" maxlength="4"/><input type="button" value="鑾峰彇" id="BMapLib_activate_btn" bid="activate" />', "</tr>", "<tr>", "<th></th>", "<td>", "</td>", "</tr>", "<tr>", '<th style="vertical-align:top;padding-top:7px;">鎺ユ敹鏂规墜鏈哄彿</th>', '<td><div><input type="text" id="BMapLib_phone_1" class="BMapLib_sms_input BMapLib_sms_input_l" maxlength="11"/><input type="checkbox" id="BMapLib_is_remember_phone"/>璁颁綇姝ゅ彿</div>', '<div id="BMapLib_add_phone_con"></div>', '<div><a href="javascript:void(0)" id="BMapLib_add_phone_btn" bid="addPhone">鏂板</a></div>', "</td>", "</tr>", "<tr>", "<th></th>", '<td ><input type="text" id="BMapLib_ver_input"  maxlength="4" style="width:67px;border: 1px solid #a5acb2;vertical-align: middle;height:18px;" tabindex="5" placeholder="楠岃瘉鐮�"><img width="69" height="20" id="BMapLib_ver_image" bid="BMapLib_ver_image" style="border: 1px solid #d5d5d5;vertical-align:middle;margin-left: 5px;" alt="鐐瑰嚮鏇存崲鏁板瓧" title="鐐瑰嚮鏇存崲鏁板瓧"></td>', "</tr>", "<tr>", "<th></th>", '<td><input type="button" value="鍏嶈垂鍙戦€佸埌鎵嬫満" bid="sendToPhoneBtn"/></td>', "</tr>", "</table>", "</div>", '<div class="BMapLib_mp" id="pnl_phone_right" style="display: block;">', '<div class="BMapLib_mp_title">鐭俊鍐呭锛�</div>', '<div id="BMapLib_msgContent" class="BMapLib_msgContent"></div>', "</div>", '<div style="clear:both;"></div>', '<p id="BMapLib_sms_declare_phone" class="BMapLib_sms_declare_phone">鐧惧害淇濊瘉涓嶅悜浠讳綍绗笁鏂规彁渚涜緭鍏ョ殑鎵嬫満鍙风爜</p>', '<div id="tipError" class="tip fail" style="display:none;">', '<span id="tipText"></span>', '<a href="javascript:void(0)" id="tipClose" class="cut"></a>', "</div>", '<div id="sms_lack_tip" style="display:none;">宸茶揪姣忔棩5娆＄煭淇′笂闄�</div>', '<div id="sms_unlogin_tip" style="display:none;">', '<div style="padding-left:40px;">', '<ul class="login_ul"><li id="normal_login-2" class="login_hover"><a href="javascript:void(0)">鎵嬫満鐧诲綍</a></li></ul>', '<div id="loginBox_02" class="loginBox">', '<div id="pass_error_info-2" class="pass_error_style"></div>', '<div id="passports-2"></div>', '<div id="loginIframe_iph-2" style="display:none"></div>', "</div>", "</div>", '<div class="nopass" style="padding-left:128px;">娌℃湁鐧惧害甯愬彿锛�<a href="https://passport.baidu.com/v2/?reg&amp;regType=1&amp;tpl=ma" target="_blank">绔嬪嵆娉ㄥ唽</a></div>', "</div>", "</div>", '<button class="BMapLib_popup_close" bid="close"></button>', '<div id="BMapLib_success_tip" style="display:none;">鎮ㄧ殑鐭俊宸茬粡鍙戦€佸埌鎮ㄧ殑鎵嬫満锛岃娉ㄦ剰鏌ユ敹!</div>'].join("");
		...
		checkActivateAction: function() {
			...
			function(t) {
				t && 0 != t.isactivate ? (e.dom.activateBox.style.display = "none", e.dom.activateTip.style.color = "green", e.dom.activateTip.innerHTML = "宸叉縺娲�") : (e.dom.activateBox.style.display = "table-row", e.dom.activateTip.style.color = "red", e.dom.activateTip.innerHTML = "鏈縺娲�")
			})
		},
		...
		generalMessage: function() {
			...
			i = this.iw,
			n = i.getPosition();
			this.userPhone && (e += this.userPhone + "鍒嗕韩涓€涓綅缃粰鎮紝"),
			i.getTitle && (e += "鍚嶇О涓猴細" + i.getTitle() + "锛�"),
			this.address && (e += "澶ц嚧浣嶇疆鍦�" + this.address + "锛�");
		...
		addPhoneAction: function() {
			if (this.addPhoneNum >= 4);
				...
				var t = document.createElement("div");
				t.innerHTML = '<input type="text" class="BMapLib_sms_input BMapLib_sms_input_l" maxlength="11"/><a href="javascript:void(0);" style="margin-left:5px;" bid="deletePhone">鍒犻櫎</a>',
